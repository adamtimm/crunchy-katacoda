...
docker run -d -p 5432:5432 -e PG_USER=groot -e PG_PASSWORD=password -e PG_DATABASE=firedata -e PG_ROOT_PASSWORD=root --name=pgsql crunchydata/crunchy-postgres-appdev
